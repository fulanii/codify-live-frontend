    ...
    <div className="min-h-screen bg-background">
        ...
        <section id="features" className="py-20 md:py-32 bg-muted/30">
          <div className="container px-4 md:px-8 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Add Friends */}
              <Card
                className="p-8 hover-elevate transition-all duration-300 fade-in-on-scroll opacity-0 will-change-transform"
      ...
      <footer className="border-t py-12 md:py-16 bg-muted/30">
        <div className="container px-4 md:px-8 mx-auto">
          ...
          <div className="border-t pt-8 text-center text-sm text-muted-foreground fade-in-on-scroll opacity-0">
